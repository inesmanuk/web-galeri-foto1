...
<body>
    ...
    <article>
        ...
        <div class="judul">
            <h1>  Gallery photo </h1>
            <h1><i> Pesona Alam Pariwisata Air Terjun Lodovavo </i></h1>
        ...
        <div class="card-wrapper">
            <div class="card-scroll">
                ...
                <div class="card">
                    ...
                    <img src="img/<?= $key["foto"] ?>" alt=""  style="width:95%;height:Auto;">
    ...
    <footer>
        <h3>dibuat oleh Maria Marsela Nini di SMK Kawula Karya Lewoleba</h3>
